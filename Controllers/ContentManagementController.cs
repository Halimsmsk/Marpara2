...
//                         // Description replacement - Plain HTML, escape logic otomatik dönüştürecek
//                         if (!string.IsNullOrEmpty(yeniDescriptionEN))
//                         {
//                             // Normal karakterler kullan - escape logic \\u formatına çevirecek
//                             var eskiDescEN = "<p>Sending money to Germany is easy with Morpara! You can transfer money directly to German bank accounts or send it to the recipient's name — all in one app.</p>";
                            
//                             // Yeni description - plain HTML
//                             var finalDescEN = $"<p>{yeniDescriptionEN}</p>";
...
//                         // Description - Template'deki actual metin
//                         if (!string.IsNullOrEmpty(ucretDescriptionEN))
//                         {
//                             var eskiUcretDescEN = "<p>With the Morpara mobile app, you won't pay any transaction fees when sending money to German accounts.</p>";
...
//                         // Title ve Description - Template'de aynı metin (1 paragraf)
//                         var eskiSureTextEN = "<p>Sending money to Germany with MoneyGram is fast and reliable — transfers are typically completed within just a few minutes.</p>";
//                         var finalSureTextEN = $"<p>{sureTitleEN}</p>";
                        
//                         // Hem title hem description için aynı replacement
//                         copyRequestEN.BlockGridReplacements.Add(eskiSureTextEN, finalSureTextEN);
//                         _logger.LogInformation("[CopyPageFromJson] 🔍 EN Süre (title=desc): '{Old}'", eskiSureTextEN.Substring(0, Math.Min(80, eskiSureTextEN.Length)));
//                     }
