...
const ht = (n) => new et(typeof n == "string" ? n : n + "", void 0, B), xt = (n, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: lt, defineProperty: ct, getOwnPropertyDescriptor: dt, getOwnPropertyNames: pt, getOwnPropertySymbols: $t, getPrototypeOf: ut } = Object, f = globalThis, J = f.trustedTypes, _t = J ? J.emptyScript : "", k = f.reactiveElementPolyfillSupport, w = (n, t) => n, I = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? _t : null;
      break;
  ...
  return e;
} }, st = (n, t) => !lt(n, t), K = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: st };
...
let v = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      ...
      this._$Em = i, this[i] = h.fromAttribute(e, a.type) ?? ((r = this._$Ej) == null ? void 0 : r.get(i)) ?? null, this._$Em = null;
    }
  }
  requestUpdate(t, e, s) {
    var i;
    if (t !== void 0) {
      ...
      if (s ?? (s = o.getPropertyOptions(t)), !((s.hasChanged ?? st)(r, e) || s.useDefault && s.reflect && r === ((i = this._$Ej) == null ? void 0 : i.get(t)) && !this.hasAttribute(o._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, N = C.trustedTypes, Z = N ? N.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, it = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + _, ft = `<${nt}>`, g = document, P = () => g.createComment(""), x = (n) => n === null || typeof n != "object" && typeof n != "function", V = Array.isArray, At = (n) => V(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, A = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, rt = /^(?:script|style|textarea|title)$/i, mt = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), Ot = mt(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function ot(n, t) {
...
const yt = (n, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = n[a];
    let c, p, l = -1, $ = 0;
    for (; $ < h.length && (r.lastIndex = $, p = r.exec(h), p !== null); ) $ = r.lastIndex, r === b ? p[1] === "!--" ? r = F : p[1] !== void 0 ? r = G : p[2] !== void 0 ? (rt.test(p[2]) && (i = RegExp("</" + p[2], "g")), r = A) : p[3] !== void 0 && (r = A) : r === A ? p[0] === ">" ? (r = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = r.lastIndex - p[2].length, c = p[1], r = p[3] === void 0 ? A : p[3] === '"' ? X : Q) : r === X || r === Q ? r = A : r === F || r === G ? r = b : (r = A, i = void 0);
    const u = r === A && n[a + 1].startsWith("/>") ? " " : "";
    o += r === b ? h + ft : l >= 0 ? (s.push(c), h.slice(0, l) + it + h.slice(l) + _ + u) : h + _ + (l === -2 ? a : u);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(it)) {
          ...
          h.push({ type: 1, index: o, name: H[2], strings: u, ctor: H[1] === "." ? vt : H[1] === "?" ? Et : H[1] === "@" ? St : R }), i.removeAttribute(l);
...
class gt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (r === h.index) {
        let c;
        h.type === 2 ? c = new O(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new bt(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class R {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let r = !1;
    if (o === void 0) t = S(this, t, e, 0), r = !x(t) || t !== this._$AH && t !== E, r && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = o[0], h = 0; h < o.length - 1; h++) c = S(this, a[s + h], e, h), c === E && (c = this._$AH[h]), r || (r = !x(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    r && !i && this.j(t);
  }
  j(t) {
...
D == null || D(U, O), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.0");
const wt = (n, t, e) => {
...
var tt;
T._$litElement$ = !0, T.finalized = !0, (tt = y.litElementHydrateSupport) == null || tt.call(y, { LitElement: T });
...
//# sourceMappingURL=lit-element-FqBfIOu4.js.map
